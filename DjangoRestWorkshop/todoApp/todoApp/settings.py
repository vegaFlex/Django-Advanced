...
SECRET_KEY = 'django-insecure-^kt4ao+=t$eijc56(ztgibamaw_kji3uz0q#=y%l(3r*hjuk^j'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=5),  # Usually this is 5, 10, 15 mins
    'REFRESH_TOKEN_LIFETIME': timedelta(days=1),    # Usually 1 or 2 weeks
}

SPECTACULAR_SETTINGS = {
    'TITLE': 'Todo App',
    'DESCRIPTION': 'The best todo app ever made',
    'VERSION': "1.0.0",
}
